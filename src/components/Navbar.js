    ...
    return (
        <nav className='navbar bg-white flex md:flex-row flex-col justify-between items-center md:py-6 py-5 md:px-24 px-8 font-sans antialiased'>
            ...
            <ul className='flex flex-center md:mt-0 mt-3 md:text-xl text-base'>
                <li className='mx-3 text-nav-link-light hover:text-nav-link-light-hover'><a href="/#about">About</a></li>
                <li className='mx-3 text-nav-link-light hover:text-nav-link-light-hover'><Link to="/projects">Projects</Link></li>
                <li className='mx-3 text-nav-link-light hover:text-nav-link-light-hover'><Link to="/contact">Contact</Link></li>
            </ul>
        </nav>
    )
}
